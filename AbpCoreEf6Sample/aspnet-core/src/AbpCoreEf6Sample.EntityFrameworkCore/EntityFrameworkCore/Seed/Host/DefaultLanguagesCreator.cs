...
namespace AbpCoreEf6Sample.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AbpCoreEf6SampleConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AbpCoreEf6SampleDbContext context)
        {
            _context = context;
        }
