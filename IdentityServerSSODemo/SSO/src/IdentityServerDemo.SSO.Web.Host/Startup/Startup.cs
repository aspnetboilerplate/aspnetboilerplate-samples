...
using Owin;
using Abp.Owin;
using IdentityServerDemo.SSO.Owin;
#endif
...
namespace IdentityServerDemo.SSO.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "SSO API", Version = "v1" });
            ...
            return services.AddAbp<SSOWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "SSO API V1");
            }); // URL: /swagger
        }
        ...
        {
            app.Properties["host.AppName"] = "SSO";
