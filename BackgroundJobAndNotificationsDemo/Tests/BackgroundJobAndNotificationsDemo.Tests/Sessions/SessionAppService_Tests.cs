...
using BackgroundJobAndNotificationsDemo.Sessions;
using Shouldly;
using Xunit;

namespace BackgroundJobAndNotificationsDemo.Tests.Sessions
{
    public class SessionAppService_Tests : BackgroundJobAndNotificationsDemoTestBase
    {
