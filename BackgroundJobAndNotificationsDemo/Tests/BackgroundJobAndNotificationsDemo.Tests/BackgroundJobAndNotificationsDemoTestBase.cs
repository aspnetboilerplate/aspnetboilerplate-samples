...
namespace BackgroundJobAndNotificationsDemo.Tests
{
    public abstract class BackgroundJobAndNotificationsDemoTestBase : AbpIntegratedTestBase
    {
        protected BackgroundJobAndNotificationsDemoTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<BackgroundJobAndNotificationsDemoApplicationModule>();
            modules.Add<BackgroundJobAndNotificationsDemoDataModule>();
        }

        public void UsingDbContext(Action<BackgroundJobAndNotificationsDemoDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<BackgroundJobAndNotificationsDemoDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<BackgroundJobAndNotificationsDemoDbContext, T> func)
        {
            T result;
