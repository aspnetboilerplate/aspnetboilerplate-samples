...
namespace IdentityServervNextDemo.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = IdentityServervNextDemoConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(IdentityServervNextDemoDbContext context)
        {
            _context = context;
        }
