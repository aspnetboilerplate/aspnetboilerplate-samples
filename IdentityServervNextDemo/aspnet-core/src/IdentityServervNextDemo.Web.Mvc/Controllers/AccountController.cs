...
using IdentityServervNextDemo.Identity;
using IdentityServervNextDemo.MultiTenancy;
using IdentityServervNextDemo.Sessions;
using IdentityServervNextDemo.Web.Models.Account;
using IdentityServervNextDemo.Web.Views.Shared.Components.TenantChange;

namespace IdentityServervNextDemo.Web.Controllers
{
    public class AccountController : IdentityServervNextDemoControllerBase
    {
