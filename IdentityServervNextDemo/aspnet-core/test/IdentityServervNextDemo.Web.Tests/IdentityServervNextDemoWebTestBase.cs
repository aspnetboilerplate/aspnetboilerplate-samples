...
{
    public abstract class IdentityServervNextDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IdentityServervNextDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IdentityServervNextDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IdentityServervNextDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IdentityServervNextDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IdentityServervNextDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IdentityServervNextDemoDbContext, Task<T>> func)
        {
            T result;
