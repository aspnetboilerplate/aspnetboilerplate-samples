...
using IdentityServerDemo.Web.Models.Account;
...
using IdentityServerDemo.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNetCore.Identity;

namespace IdentityServerDemo.Web.Controllers
{
    public class AccountController : IdentityServerDemoControllerBase
    {
