...
using HealthCheckExample.Web.Models.Account;
using HealthCheckExample.Web.Views.Shared.Components.TenantChange;

namespace HealthCheckExample.Web.Controllers
{
    public class AccountController : HealthCheckExampleControllerBase
    {
