...
using IdentityServerWithEfCoreDemo.Web.Models.Account;
using IdentityServerWithEfCoreDemo.Web.Views.Shared.Components.TenantChange;

namespace IdentityServerWithEfCoreDemo.Web.Controllers
{
    public class AccountController : IdentityServerWithEfCoreDemoControllerBase
    {
