...
namespace IdentityServerWithEfCoreDemo.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = IdentityServerWithEfCoreDemoConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(IdentityServerWithEfCoreDemoDbContext context)
        {
            _context = context;
        }
