...
{
    public abstract class IdentityServerWithEfCoreDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IdentityServerWithEfCoreDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IdentityServerWithEfCoreDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IdentityServerWithEfCoreDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IdentityServerWithEfCoreDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IdentityServerWithEfCoreDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IdentityServerWithEfCoreDemoDbContext, Task<T>> func)
        {
            T result;
