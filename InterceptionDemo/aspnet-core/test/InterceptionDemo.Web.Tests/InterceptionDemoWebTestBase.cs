...
{
    public abstract class InterceptionDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InterceptionDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InterceptionDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InterceptionDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InterceptionDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InterceptionDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InterceptionDemoDbContext, Task<T>> func)
        {
            T result;
