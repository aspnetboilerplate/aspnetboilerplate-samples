...
using Volo.PostgreSqlDemo.Web.Models.Account;
using Volo.PostgreSqlDemo.Web.Views.Shared.Components.TenantChange;

namespace Volo.PostgreSqlDemo.Web.Controllers
{
    public class AccountController : PostgreSqlDemoControllerBase
    {
