    ...
    function (router) {
        ...
        return new function () {
            ...
            that.activate = function () {
                router.map([
                    { route: '', title: abp.localization.localize('TaskList', 'SimpleTaskSystem'), moduleId: 'viewmodels/tasklist', nav: true },
                    { route: 'newtask', title: abp.localization.localize('NewTask', 'SimpleTaskSystem'), moduleId: 'viewmodels/newtask', nav: true }
