...
{
    public abstract class MassTransitSampleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MassTransitSampleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MassTransitSampleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MassTransitSampleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MassTransitSampleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MassTransitSampleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MassTransitSampleDbContext, Task<T>> func)
        {
            T result;
