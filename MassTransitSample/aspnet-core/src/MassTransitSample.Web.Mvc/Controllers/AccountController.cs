...
using MassTransitSample.Web.Models.Account;
using MassTransitSample.Web.Views.Shared.Components.TenantChange;

namespace MassTransitSample.Web.Controllers
{
    public class AccountController : MassTransitSampleControllerBase
    {
