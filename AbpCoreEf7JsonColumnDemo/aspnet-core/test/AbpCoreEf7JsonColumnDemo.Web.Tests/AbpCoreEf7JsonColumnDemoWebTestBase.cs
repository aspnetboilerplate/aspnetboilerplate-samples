...
{
    public abstract class AbpCoreEf7JsonColumnDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AbpCoreEf7JsonColumnDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AbpCoreEf7JsonColumnDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AbpCoreEf7JsonColumnDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AbpCoreEf7JsonColumnDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AbpCoreEf7JsonColumnDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AbpCoreEf7JsonColumnDemoDbContext, Task<T>> func)
        {
            T result;
