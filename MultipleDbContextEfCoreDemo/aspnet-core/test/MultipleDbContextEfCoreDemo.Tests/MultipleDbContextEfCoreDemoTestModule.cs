...
using MultipleDbContextEfCoreDemo.Tests.DependencyInjection;
...
namespace MultipleDbContextEfCoreDemo.Tests
{
    ...
    {
        public MultipleDbContextEfCoreDemoTestModule(MultipleDbContextEfCoreDemoEntityFrameworkModule abpProjectNameEntityFrameworkModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<AbpZeroDbMigrator<MultipleDbContextEfCoreDemoDbContext>>();
