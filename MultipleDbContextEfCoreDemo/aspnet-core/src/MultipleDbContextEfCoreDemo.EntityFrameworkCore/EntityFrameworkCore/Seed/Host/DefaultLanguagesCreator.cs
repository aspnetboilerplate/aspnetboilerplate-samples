...
namespace MultipleDbContextEfCoreDemo.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = MultipleDbContextEfCoreDemoConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MultipleDbContextEfCoreDemoDbContext context)
        {
            _context = context;
        }
